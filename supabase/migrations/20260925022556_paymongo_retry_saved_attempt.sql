-- Existing live checkout sessions stay retrievable after a court rate/status
-- change or after the reservation start time. New sessions still require an
-- active, available hourly rate and a future start time.
